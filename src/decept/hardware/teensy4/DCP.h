...
constexpr DCP_Reg<&DCP_Layout::PACKET1, 6, 18> DCP_PACKET1_SWAP;
...
constexpr DCP_Reg<&DCP_Layout::CH0STAT, 8, 16> DCP_CH0STAT_ERROR_CODE;
    // Next pointer is 0x00000000 = 1
    // Semaphore is non-zero and neither chain bit is set = 2
    // An error is reported reading/writing the context buffer = 3
    // An error is reported reading/writing the payload = 4
    // Control packet specifies an invalid mode select (for instance, blit + hash) = 5
