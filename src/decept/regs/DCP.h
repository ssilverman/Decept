...
#define DCP_MEMBER(member) (kDCP_base + offsetof(DCP_Layout, member))

// DCP control register 0
constexpr Reg<DCP_MEMBER(CTRL), 8,  0> DCP_CTRL_CHANNEL_INTERRUPT_ENABLE;
constexpr Reg<DCP_MEMBER(CTRL), 1, 21> DCP_CTRL_ENABLE_CONTEXT_SWITCHING;
constexpr Reg<DCP_MEMBER(CTRL), 1, 22> DCP_CTRL_ENABLE_CONTEXT_CACHING;
constexpr Reg<DCP_MEMBER(CTRL), 1, 23> DCP_CTRL_GATHER_RESIDUAL_WRITES;
constexpr Reg<DCP_MEMBER(CTRL), 1, 28> DCP_CTRL_PRESENT_SHA;
constexpr Reg<DCP_MEMBER(CTRL), 1, 29> DCP_CTRL_PRESENT_CRYPTO;
constexpr Reg<DCP_MEMBER(CTRL), 1, 30> DCP_CTRL_CLKGATE;
constexpr Reg<DCP_MEMBER(CTRL), 1, 31> DCP_CTRL_SFTRESET;

// DCP status register
constexpr Reg<DCP_MEMBER(STAT), 1, 28> DCP_STAT_OTP_KEY_READY;

// DCP channel control register
constexpr Reg<DCP_MEMBER(CHANNELCTRL),  8,  0> DCP_CHANNELCTRL_ENABLE_CHANNEL;
constexpr Reg<DCP_MEMBER(CHANNELCTRL), 15, 17> DCP_CHANNELCTRL_RSVD;

// DCP key index
constexpr Reg<DCP_MEMBER(KEY), 2, 0> DCP_KEY_SUBWORD;
constexpr Reg<DCP_MEMBER(KEY), 2, 4> DCP_KEY_INDEX;

// DCP work packet 1 status register
constexpr Reg<DCP_MEMBER(PACKET1), 1,  1> DCP_PACKET1_DECR_SEMAPHORE;
constexpr Reg<DCP_MEMBER(PACKET1), 1,  5> DCP_PACKET1_ENABLE_CIPHER;
constexpr Reg<DCP_MEMBER(PACKET1), 1,  6> DCP_PACKET1_ENABLE_HASH;
constexpr Reg<DCP_MEMBER(PACKET1), 1,  8> DCP_PACKET1_CIPHER_ENCRYPT;
constexpr Reg<DCP_MEMBER(PACKET1), 1,  9> DCP_PACKET1_CIPHER_INIT;
constexpr Reg<DCP_MEMBER(PACKET1), 1, 10> DCP_PACKET1_OTP_KEY;
constexpr Reg<DCP_MEMBER(PACKET1), 1, 11> DCP_PACKET1_PAYLOAD_KEY;
constexpr Reg<DCP_MEMBER(PACKET1), 1, 12> DCP_PACKET1_HASH_INIT;
constexpr Reg<DCP_MEMBER(PACKET1), 1, 13> DCP_PACKET1_HASH_TERM;
constexpr Reg<DCP_MEMBER(PACKET1), 6, 18> DCP_PACKET1_SWAP;

// DCP work packet 2 status register
constexpr Reg<DCP_MEMBER(PACKET2), 4,  0> DCP_PACKET2_CIPHER_SELECT;
constexpr Reg<DCP_MEMBER(PACKET2), 4,  4> DCP_PACKET2_CIPHER_MODE;
