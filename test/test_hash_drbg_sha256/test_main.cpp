...
// test_main.cpp tests the SHA-256-based Hash_DRBG.
...
extern const size_t sha256_pr_false_data_size;
extern const PRTrueTestData sha256_pr_true_data[];
extern const size_t sha256_pr_true_data_size;
...
static void test_no_reseed_sha256() {
  test_no_reseed<decept::Hash::kSHA256>(sha256_no_reseed_data,
                                        sha256_no_reseed_data_size);
}

static void test_pr_false_sha256() {
  test_pr_false<decept::Hash::kSHA256>(sha256_pr_false_data,
                                       sha256_pr_false_data_size);
}

static void test_pr_true_sha256() {
  test_pr_true<decept::Hash::kSHA256>(sha256_pr_true_data,
                                      sha256_pr_true_data_size);
}
...
void setup() {
  ...
  UNITY_BEGIN();
  RUN_TEST(test_no_reseed_sha256);
  RUN_TEST(test_pr_false_sha256);
  RUN_TEST(test_pr_true_sha256);
  UNITY_END();
